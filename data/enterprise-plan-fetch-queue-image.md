...
Enterprise: Fetch Queue Image \| Stable Diffusion API Documentation
...
* [Enterprise Plan](/docs/category/enterprise-plan)
* Fetch Queued Images
On this pageEnterprise: Fetch Queue Image
=============================
...
```
--request POST 'https://stablediffusionapi.com/api/v1/enterprise/fetch' \  

```
Send a `POST` request to <https://stablediffusionapi.com/api/v1/enterprise/fetch> endpoint to return the corresponding queued images, specified by the **request\_id** parameter in the request body.
...
fetch("https://stablediffusionapi.com/api/v1/enterprise/fetch", requestOptions)  
...
curl_setopt_array($curl, array(  
  CURLOPT_URL => 'https://stablediffusionapi.com/api/v1/enterprise/fetch',  
...
var options = {  
  'method': 'POST',  
  'url': 'https://stablediffusionapi.com/api/v1/enterprise/fetch',  
  'headers': {  
    'Content-Type': 'application/json'  
  },  
  body: JSON.stringify({  
...
```
[PreviousNSFW Image Check](/docs/enterprise-plan/nsfw-image-check)[NextDreambooth Sandbox](/docs/category/dreambooth-sandbox)* [Overview](#overview)
* [Request](#request)
