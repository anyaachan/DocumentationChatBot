...
Enterprise: Clear API Cache Endpoint \| Stable Diffusion API Documentation
...
* [Enterprise Plan](/docs/category/enterprise-plan)
* Clear Cache
On this pageEnterprise: Clear API Cache Endpoint
====================================
...
curl_setopt_array($curl, array(  
  CURLOPT_URL => 'https://stablediffusionapi.com/api/v1/enterprise/clear_cache',  
...
var options = {  
  'method': 'POST',  
  'url': 'https://stablediffusionapi.com/api/v1/enterprise/clear_cache',  
  'headers': {  
    'Content-Type': 'application/json'  
  },  
  body: JSON.stringify({  
...
```
[PreviousUpdate S3 Details](/docs/enterprise-plan/update-s3-details)[NextList Schedulers](/docs/enterprise-plan/list-schedulers)* [Overview](#overview)
* [Request](#request)
