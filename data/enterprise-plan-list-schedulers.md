...
Enterprise: List Schedulers Endpoint \| Stable Diffusion API Documentation
...
* [Enterprise Plan](/docs/category/enterprise-plan)
* List Schedulers
On this pageEnterprise: List Schedulers Endpoint
====================================
...
```
--request POST 'https://stablediffusionapi.com/api/v1/enterprise/schedulers_list' \  

```
Send a `POST` request to <https://stablediffusionapi.com/api/v1/enterprise/schedulers_list> endpoint to clear the API's cache.
...
fetch("https://stablediffusionapi.com/api/v1/enterprise/schedulers_list", requestOptions)  
...
var options = {  
  'method': 'POST',  
  'url': 'https://stablediffusionapi.com/api/v1/enterprise/schedulers_list',  
  'headers': {  
    'Content-Type': 'application/json'  
  },  
  body: JSON.stringify({  
...
```
[PreviousClear Cache](/docs/enterprise-plan/clear-cache)[NextLoad Model](/docs/enterprise-plan/load-model)* [Overview](#overview)
* [Request](#request)
