...
Enterprise: System Details Endpoint \| Stable Diffusion API Documentation
...
* [Enterprise Plan](/docs/category/enterprise-plan)
* System Details
On this pageEnterprise: System Details Endpoint
===================================
...
```
Send a `POST` request to <https://stablediffusionapi.com/api/v1/enterprise/system_details> endpoint to get information about your server.
...
fetch("https://stablediffusionapi.com/api/v1/enterprise/system_details", requestOptions)  
...
curl_setopt_array($curl, array(  
  CURLOPT_URL => 'https://stablediffusionapi.com/api/v1/enterprise/system_details',  
...
var options = {  
  'method': 'POST',  
  'url': 'https://stablediffusionapi.com/api/v1/enterprise/system_details',  
  'headers': {  
    'Content-Type': 'application/json'  
  },  
  body: JSON.stringify({  
...
```
[PreviousAPI Overview](/docs/enterprise-plan/overview)[NextRestart Server](/docs/enterprise-plan/restart-server)* [Overview](#overview)
* [Request](#request)
