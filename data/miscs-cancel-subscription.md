...
Automatically Cancel Subscription Plan \| Stable Diffusion API Documentation
...
On this pageAutomatically Cancel Subscription Plan
======================================
...
```
cautionBefore calling this endpoint, you must have purchased subscription via **[this endpoint](/docs/miscs/buy-subscription)**

Send a `POST` request to <https://stablediffusionapi.com/api/v3/cancel_subscription> endpoint and pass the desired **key\_to\_cancel** .
...
curl_setopt_array($curl, array(  
  CURLOPT_URL => 'https://stablediffusionapi.com/api/v3/cancel_subscription',  
...
var options = {  
  'method': 'POST',  
  'url': 'https://stablediffusionapi.com/api/v3/cancel_subscription',  
  'headers': {  
    'Content-Type': 'application/json'  
  },  
  body: JSON.stringify({  
...
```
[PreviousBuy Subscription Plan](/docs/miscs/buy-subscription)[NextNSFW Image Check](/docs/miscs/nsfw-image-check)* [Overview](#overview)
* [Request](#request)
