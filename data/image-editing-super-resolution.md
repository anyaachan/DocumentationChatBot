...
Super Resolution Endpoint \| Stable Diffusion API Documentation
...
* [Image Editing](/docs/category/image-editing)
* Super Resolution
On this pageSuper Resolution Endpoint
=========================
...
![Super Resolution endpoint result](/docs/assets/images/super-res-action-sm-03f81fbaeda5b4d52cc825de8405df35.png)Request[â](#request "Direct link to Request")
-----------------------------------------------
...
| **face\_enhance** | A boolean flag (*true/false*) for face enhancement feature |
...
```
[PreviousRemove Background](/docs/image-editing/removebg-createmask)[NextMixture Canvas](/docs/image-editing/mixture-canvas)* [Overview](#overview)
* [Request](#request)
