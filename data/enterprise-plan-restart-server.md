...
Enterprise: Restart Server Endpoint \| Stable Diffusion API Documentation
...
* [Enterprise Plan](/docs/category/enterprise-plan)
* Restart Server
On this pageEnterprise: Restart Server Endpoint
===================================
...
var options = {  
  'method': 'POST',  
  'url': 'https://stablediffusionapi.com/api/v1/enterprise/restart_server',  
  'headers': {  
    'Content-Type': 'application/json'  
  },  
  body: JSON.stringify({  
...
```
[PreviousSystem Details](/docs/enterprise-plan/system-details)[NextUpdate Server](/docs/enterprise-plan/update-server)* [Overview](#overview)
* [Request](#request)
