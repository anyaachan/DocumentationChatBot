...
Enterprise: Update Server Endpoint \| Stable Diffusion API Documentation
...
* [Enterprise Plan](/docs/category/enterprise-plan)
* Update Server
On this pageEnterprise: Update Server Endpoint
==================================
...
```
--request POST 'https://stablediffusionapi.com/api/v1/enterprise/update_server' \  

```
Send a `POST` request to <https://stablediffusionapi.com/api/v1/enterprise/update_server> endpoint to update your dedicated server.
...
fetch("https://stablediffusionapi.com/api/v1/enterprise/update_server", requestOptions)  
...
curl_setopt_array($curl, array(  
  CURLOPT_URL => 'https://stablediffusionapi.com/api/v1/enterprise/update_server',  
...
var options = {  
  'method': 'POST',  
  'url': 'https://stablediffusionapi.com/api/v1/enterprise/update_server',  
  'headers': {  
    'Content-Type': 'application/json'  
  },  
  body: JSON.stringify({  
...
```
[PreviousRestart Server](/docs/enterprise-plan/restart-server)[NextUpdate S3 Details](/docs/enterprise-plan/update-s3-details)* [Overview](#overview)
* [Request](#request)
